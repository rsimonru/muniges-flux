...
use App\Models\SportsEventsPaymentsType;
use Illuminate\Database\Seeder;
use Illuminate\Support\Facades\Schema;

class SportsEventsPaymentsTypesTableSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        SportsEventsPaymentsType::upsert($records, ['id'], ['description', 'created_at', 'updated_at']);
